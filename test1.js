...
async function doRequest() {
  const signParams = {
    ...
    bodySha: getBodySha(JSON.stringify({
      SmsAccount: '7555c16e',
      Sign: '火山测试',
    ...
    accessKeyId: 'AKLTNTQ4ZWY1ODkxOGQwNGJjNzk3ZTFmNGE4YmEwZDVhNzM',
    //accessKeyId: GenerateAccessKeyId("AKTP"), //'AKLTNTQ4ZWY1ODkxOGQwNGJjNzk3ZTFmNGE4YmEwZDVhNzM',
    secretAccessKey: 'TUdVek9XWTRORE15TVdZMU5ESmpaV0kzTVRReVpqTXhaV1E0WVRNd1pqZw==',
    serviceName: 'volcSMS',
    region: 'cn-north-1',
  };
  ...
  const res = await fetch(`https://sms.volcengineapi.com/?${qs.stringify(signParams.query)}`, {
    headers: {
      ...
      // AccessKey: signParams.accessKeyId,
      // SecretKey: signParams.secretKey,
      // ServiceName: 'volcSMS',
      // Region: 'cn-north-1',
      // 'Content-Type': 'application/json;charset=utf-8'
    },
    method: signParams.method,
    body: getBodySha(JSON.stringify({
      SmsAccount: '7555c16e',
      Sign: '火山测试',
      TemplateID: 'ST_7555b0df',
      Scene: '注册验证码',
